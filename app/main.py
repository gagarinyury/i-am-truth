...
class AnalyzeRequest(BaseModel):
    ...
    # пути шестнадцать прогонов на своём эталоне и двадцать на внешнем, у ADK по
    # два (медиана 5.25 против 5.5 на McDonald, 3.5 против 3.5 на Cheng — F-46).
    ...
    # укладывается в 28-128 (медиана 40). Поэтому выбор явный, а по умолчанию
    # стоит быстрый путь. Подробнее — в докстроке `pipeline.run`.
    engine: str = "direct"
